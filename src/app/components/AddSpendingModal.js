...
import { ChevronDown } from "lucide-react"; // custom arrow
    ...
    return (
        <AnimatePresence>
            ...
            >
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full pl-7 pr-4 py-2 rounded-lg bg-gray-800 text-white
                             focus:outline-none focus:ring-2 focus:ring-blue-500
                             [appearance:textfield]
                             [&::-webkit-outer-spin-button]:appearance-none
                             [&::-webkit-inner-spin-button]:appearance-none
                             [-moz-appearance:textfield]"
                                    onWheel={(e) => e.currentTarget.blur()} // disable scroll changing value
                                />
                            </div>

                            {/* Category (custom dropdown like dashboard) */}
               ...
               hover:bg-gray-500 transform hover:scale-105 active:scale-95 
               transition duration-150 ease-in-out"
                            ...
                            <button
                                type="submit"
                                className="px-4 py-2 bg-blue-600 rounded-lg text-white cursor-pointer 
